...
controller("GdpEditCtrl", ["$scope", "$http", "$routeParams", "$location", function($scope, $http, $routeParams, $location) {
    ...
    function refresh() {
        $http
            .get("../api/v1/gdp/" + $routeParams.country + "/" + $routeParams.year + "?" + "apikey=" + apikey)
