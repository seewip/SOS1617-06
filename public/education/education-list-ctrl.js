...
controller("EducationListCtrl", ["$scope", "$http", "$rootScope", function($scope, $http, $rootScope) {
    ...
    $scope.addData = function() {
        $http
            .post("../api/v1/education" + "?" + "apikey=" + $rootScope.apikey, $scope.newData)
            .then(function(response) {
    ...
    $scope.delData = function(data) {
        $http
            .delete("../api/v1/education/" + data.country + "/" + data.year + "?" + "apikey=" + $rootScope.apikey)
            .then(function(response) {
    ...
    $scope.delAllData = function() {
        $http
            .delete("../api/v1/education" + "?" + "apikey=" + $rootScope.apikey)
            .then(function(response) {
    ...
    $scope.loadInitialData = function() {
        ...
        if ($scope.data.length == 0) {
            $http
                .get("../api/v1/education/loadInitialData" + "?" + "apikey=" + $rootScope.apikey)
                .then(function(response) {
