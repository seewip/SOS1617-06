...
app.get(BASE_API_PATH + "/tests", function(request, response) {
    response.send("<html><head><title>Tests</title></head><body><h1>Tests</h1>"
    +"<p>Cristina Leal Echevarría - gdp: </p>"
    +'<p>Mateusz Dominik - education: </p><div class="postman-run-button" data-postman-action="collection/import" data-postman-var-1="f2250ecc94e7e9fb7375"></div>'
    +"<p>Jihane Fahri - gdp-per-capita: </p>"
    // Script to generate button
